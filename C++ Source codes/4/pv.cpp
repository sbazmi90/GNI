...
main()
{
  ...
  FILE *af0,*af1,*af2,*af3,*af4,*af5,*af6,*af7,*af8,*af9,*af10,*af11;
  ...
  af10=fopen("Object10.txt","w");
 
  af11=fopen("Energy.txt","w");
  ...
  for(i=1;i<=N;i++)
    {
      ...
      if(i==10) fprintf(af10,"0  %20.18f %20.18f \n",x[i],y[i]);
      if(i==11) fprintf(af11,"0  %20.18f %20.18f \n",x[i],y[i]);
    }
      ...
      if(t%7200==0)
	{
	  for(i=1;i<=N;i++)
	    {  
	      ...
	      if(i==10) fprintf(af10,"%d  %20.18f %20.18f \n",t/7200,x[i],y[i]);
	    }

	  fprintf(af11,"%d  %20.18f %20.18f %20.18f %20.18f \n",t/7200, px, py, lz, H);
	}
